...
package uz.android.creditCardNfcReader.nfc.reader;
...
import uz.android.creditCardNfcReader.nfc.reader.pboc.StandardPboc;


public final class ReaderManager extends AsyncTask<Tag, SPEC.EVENT, Card> {

    private final ReaderListener realListener;
